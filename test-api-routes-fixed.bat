...
echo === API ROUTES VERIFICATION (FIXED) ===
echo.
...
echo 11. Testing New Customers - Get Expenses...
curl -s -X GET %API%/new-customers/expenses -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 12. Testing New Customers - Get Collections...
curl -s -X GET %API%/new-customers/collections -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 13. Testing Areas - Get All Areas...
curl -s -X GET %API%/areas -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 14. Testing Complaints - Get All Complaints...
curl -s -X GET %API%/complaints -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 15. Testing Announcements - Get All Announcements...
curl -s -X GET %API%/announcements -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 16. Testing Reports - Customer Reports...
curl -s -X GET "%API%/reports/customers" -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 17. Testing Reports - Billing Reports...
curl -s -X GET "%API%/reports/billing" -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 18. Testing Reports - Income Reports...
curl -s -X GET "%API%/reports/income" -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 19. Testing Reports - Expenses Reports...
curl -s -X GET "%API%/reports/expenses" -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 20. Testing Reports - Business Reports...
curl -s -X GET "%API%/reports/business" -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 21. Testing Dashboard - Get Statistics...
curl -s -X GET "%API%/dashboard/statistics?stage=summary" -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 22. Testing Roles - Get All Roles...
curl -s -X GET %API%/roles -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 23. Testing Logs - Get All Logs...
curl -s -X GET %API%/logs -H "Authorization: Bearer %TOKEN%"
echo.
echo.

echo 24. Testing Notifications - Get Notifications...
