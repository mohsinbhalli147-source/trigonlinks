...
import { Bell, Send, Trash2, Eye, Clock, Calendar, Filter, Search, Users } from 'lucide-react';
import DateFilter, { DateFilterType } from '../components/DateFilter';
import { announcementsApi } from '../services/api';

export default function AnnouncementCustomer() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-[#EAF0FB]">Customer Announcements</h2>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs text-[#5C6B85]">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>{announcement.targetArea}</span>
                  </div>
                  <div className="flex items-center gap-1">
      ...
      {filteredAnnouncements.length === 0 && (
        <div className="bg-[#121B2E] border border-[#232D45] rounded-xl p-12 text-center">
          <Users className="w-12 h-12 text-[#5C6B85] mx-auto mb-4" />
