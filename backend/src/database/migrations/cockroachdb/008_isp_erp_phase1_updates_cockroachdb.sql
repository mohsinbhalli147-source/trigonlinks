-- Migration 008: Complete ISP ERP Phase 1 Updates (CockroachDB Compatible)
...
-- 3. Invoice Type Enum & Column (CockroachDB compatible - use VARCHAR with CHECK)
DO $$
BEGIN
    -- Skip enum creation, will use VARCHAR with CHECK constraint
END $$;
